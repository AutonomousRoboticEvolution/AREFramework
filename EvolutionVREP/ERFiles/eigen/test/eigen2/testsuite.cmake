...
#  - in that folder, do:
#    ctest -S path/to/eigen2/test/testsuite.cmakeModules[,option1=value1[,option2=value2]]
#
# Options:
...
#  - EIGEN_CMAKE_DIR: path to cmakeModules executable
...
#  - EIGEN_CMAKE_ARGS: additional arguments passed to cmakeModules
...
# wget http://bitbucket.org/eigen/eigen/raw/tip/test/testsuite.cmake -o $WORK_DIR/testsuite.cmakeModules
# COMMON="ctest -S $WORK_DIR/testsuite.cmakeModules,EIGEN_WORK_DIR=$WORK_DIR,EIGEN_SITE=$SITE,EIGEN_MODE=$1,EIGEN_BUILD_STRING=$OS_VERSION-$ARCH"
...
# what cmakeModules command to use for configuring this dashboard
