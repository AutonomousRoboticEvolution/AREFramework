...
void LinearCombination::initPopulation()
{
...
void LinearCombination::setObjectives(size_t indIdx, const std::vector<double> &objectives){
    currentIndIndex = indIdx;
    population[indIdx]->setObjectives(objectives);
}

void LinearCombination::init_next_pop(){
    int manufacturabilityMethod = settings::getParameter<settings::Integer>(parameters,"#manufacturabilityMethod").value;
    population.clear();
...
bool LinearCombination::is_finish()
{
