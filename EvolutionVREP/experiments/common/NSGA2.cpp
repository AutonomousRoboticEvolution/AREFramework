...
void NSGA2::selection(){
    ...
    for(size_t i = 0; i < population.size() - 4; i+=4){
    ...
    int NSGA2::check_dominance(const std::vector<double>& objs1,const std::vector<double>& objs2){
    ...
    void NSGA2::non_dominated_sort(const std::vector<indPtr> &pop){
    ...
    void NSGA2::crowding_distance(int rank){
   ...
   indPtr NSGA2::tournament(const indPtr & ind1,const indPtr &ind2){
