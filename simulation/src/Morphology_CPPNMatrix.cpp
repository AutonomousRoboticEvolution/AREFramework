...
void Morphology_CPPNMatrix::create_without_substrate(){
    int meshHandle = -1;
    std::vector<std::vector<std::vector<int>>> skeletonSurfaceCoord;
    mainHandle = -1;
    int convexHandle, brainHandle;
...
void Morphology_CPPNMatrix::createAtPosition_without_substrate(float x, float y, float z){
    create_without_substrate();
    bool verbose = settings::getParameter<settings::Boolean>(parameters,"#verbose").value;
    if(verbose){
        float mass;
        float inertiaMatrix[9];
