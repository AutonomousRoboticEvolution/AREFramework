...
//        if(name == "aruco_big_bl")
//            big_corner_handles.push_back(handles[i]);
//        else if(name == "aruco_big_br")
//            big_corner_handles.push_back(handles[i]);
//        else if(name == "aruco_big_tl")
//            big_corner_handles.push_back(handles[i]);
//        else if(name == "aruco_big_tr")
//            big_corner_handles.push_back(handles[i]);
//        else if(name == "aruco_small_br")
//            small_corner_handles.push_back(handles[i]);
//        else if(name == "aruco_small_tl")
//            small_corner_handles.push_back(handles[i]);
//        else if(name == "aruco_small_bl")
//            small_corner_handles.push_back(handles[i]);
//        else if(name == "aruco_small_tr")
//            small_corner_handles.push_back(handles[i]);
    }
...
//    det = simReadProximitySensor(camera_handle,pos,&detected_object_handle,norm);
...
//        occl = simReadProximitySensor(occlusion_detector,pos,&detected_object_handle,norm);
//        if(occl > 0){
