                               ...
                               const are::settings::ParametersMapPtr &param)
{
    ...
    std::string ctrl_log_file = are::settings::getParameter<are::settings::String>(param,"#controlFile").value;
    are::ControlLog::Ptr ctrllog(new are::ControlLog(ctrl_log_file));
