...
namespace are {
    ...
    class ControlLog : public Logging
    {
    public:
        ControlLog(const std::string &file) : Logging(file,true){} //Logging at the end of the generation
        void saveLog(EA::Ptr & ea);
        void loadLog(const std::string& logFile){}
    };
    ...
    class ProtoPhenotypeLog : public Logging
    {
    public:
        ProtoPhenotypeLog(const std::string &file) : Logging(file, true){}
        void saveLog(EA::Ptr & ea);
        void loadLog(const std::string& logFile){}
    };
