...
void TestsLog::saveLog(EA::Ptr &ea)
{
    ...
    for(size_t ind = 0; ind < ea->get_population().size(); ind++){
        ...
        for(size_t j = 0; j < manRes.size(); j++){
...
void morphDescCartWHDLog::saveLog(EA::Ptr &ea)
{
    ...
    for(size_t ind = 0; ind < ea->get_population().size(); ind++){
        ...
        logFileStream << morphDesc(0);
        for(size_t j = 1; j < morphDesc.size(); j++){
...
void SkeletonMatrixLog::saveLog(EA::Ptr &ea)
{
    ...
    for(size_t i = 0; i < ea->get_population().size(); i++){
        ...
        logFileStream << "angle" << ",";
        for(size_t i = 0; i < matrix_4d.at(0).size(); i++){
        ...
        for(size_t i = 0; i < matrix_4d.at(1).size(); i++){
        ...
        logFileStream << std::endl;
        logFileStream << "wheel" << ",";
        for(size_t i = 0; i < matrix_4d.at(2).size(); i++){
        ...
        for(size_t i = 0; i < matrix_4d.at(3).size(); i++){
        ...
        logFileStream << std::endl;
        logFileStream << "joint" << ",";
        for(size_t i = 0; i < matrix_4d.at(4).size(); i++){
        ...
        for(size_t i = 0; i < matrix_4d.at(5).size(); i++){
...
void OrganPositionDescLog::saveLog(EA::Ptr &ea)
{
    ...
    for(size_t ind = 0; ind < ea->get_population().size(); ind++){
        ...
        for(size_t j = 0; j < morphDesc.size(); j++){
            logFileStream << morphDesc(j) << ",";
        }
        logFileStream << std::endl;
    }
