...
class RLExploration : public VirtualEnvironment
{
public:

    typedef std::shared_ptr<RLExploration> Ptr;
    typedef std::shared_ptr<const RLExploration> ConstPtr;

    RLExploration(const settings::ParametersMapPtr& params);
