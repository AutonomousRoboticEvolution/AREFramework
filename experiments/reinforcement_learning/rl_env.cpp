...
RLExploration::RLExploration(const settings::ParametersMapPtr& params)
{
    parameters = params;
...
std::vector<double> RLExploration::fitnessFunction(const Individual::Ptr &ind){
...
std::pair<int,int> RLExploration::real_coordinate_to_matrix_index(const std::vector<double> &pos){
...
float RLExploration::updateEnv(float simulationTime, const Morphology::Ptr &morph){
...
void RLExploration::build_tiled_floor(std::vector<int> &tiles_handles){
