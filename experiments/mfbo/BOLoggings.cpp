...
void BOBehavDescLog::saveLog(EA::Ptr &ea)
{
...
void BOLog::saveLog(EA::Ptr &ea)
{
    ...
    Eigen::VectorXd obs = static_cast<const MFBO*>(ea.get())->getLastObs();
    Eigen::VectorXd spl = static_cast<const MFBO*>(ea.get())->getLastSpl();
