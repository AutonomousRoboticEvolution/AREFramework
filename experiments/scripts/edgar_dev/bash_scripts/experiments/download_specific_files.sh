...
if [[ $ISVIKING == 1 ]]; then
	...
	ORIGIN="ebb505@viking.york.ac.uk:/users/ebb505/scratch/are-logs/mnipes2_12_6_14*"
else
	if [[ $ISAREPC == 1 ]]; then
...
DESTINATION="/media/ebb505/ARE-EBB/ARE/are-logs/mnipes_experiments/corridor/4/"
