...
if [[ $ISVIKING == 1 ]]; then
	...
	ORIGIN="ebb505@viking.york.ac.uk:/users/ebb505/scratch/are-logs/bodyplantesting_protomatrix*"
else
	if [[ $ISAREPC == 1 ]]; then
...
DESTINATION="/media/ebb505/ARE-EBB/ARE/are-logs/diversity/protomatrix_bin_100_75/"
