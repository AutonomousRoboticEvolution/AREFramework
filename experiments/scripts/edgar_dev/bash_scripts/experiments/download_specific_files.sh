...
if [[ $ISVIKING == 1 ]]; then
	...
	ORIGIN="ebb505@viking.york.ac.uk:/users/ebb505/scratch/are-logs/diversity/protomatrix_100_25/body*"
else
	if [[ $ISAREPC == 1 ]]; then
        	echo "Downloading from are-pc"
        	ORIGIN="are@areevo0.york.ac.uk:/home/are/are-logs/legs_exp/all_in/4_targets/"
	else
		echo "Wrong!"
	fi
fi
DESTINATION="/media/ebb505/ARE-EBB/ARE/are-logs/diversity/protomatrix_100_25/"
