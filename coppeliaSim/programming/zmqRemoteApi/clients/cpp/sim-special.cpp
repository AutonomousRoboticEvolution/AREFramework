...
json sim::callScriptFunction(std::string functionName, int64_t scriptHandle, json inArgs, int timeout)
{
    bool _brk = false;
    ...
    auto _ret = this->_client->call("sim.callScriptFunction", _args, timeout);
    return _ret;
}
