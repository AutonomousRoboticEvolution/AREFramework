...
void EA_Dynamic::split_line(string& line, string delim, list<string>& values)
{
	size_t pos = 0;
...
void EA_Dynamic::init()
{
	initializePopulation();
}

void EA_Dynamic::selection()
{
	// 
	createNewGenRandomSelect();
}

void EA_Dynamic::replacement()
{
...
void EA_Dynamic::mutation() {
	for (int i = 0; i < nextGenGenomes.size(); i++) {
		nextGenGenomes[i]->mutate();
	}
}

void EA_Dynamic::initializePopulation()
{
...
void EA_Dynamic::loadPopulationGenomes(int scenenum)
{
...
void EA_Dynamic::createNewGenRandomSelect() {
...
void EA_Dynamic::replaceNewPopRandom(int numAttempts)
{
...
void EA_Dynamic::replaceNewRank()
{
