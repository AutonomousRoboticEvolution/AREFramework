...
EdgarsAmazingMorphologyClass::EdgarsAmazingMorphologyClass()
{
}
...
vector<int> EdgarsAmazingMorphologyClass::getObjectHandles(int parentHandle)
{
	return vector<int>();
}

vector<int> EdgarsAmazingMorphologyClass::getJointHandles(int parentHandle)
{
	return vector<int>();
}

void EdgarsAmazingMorphologyClass::update() {

}

int EdgarsAmazingMorphologyClass::getMainHandle()
{
	return mainHandle;
}

void EdgarsAmazingMorphologyClass::create()
{

}

void EdgarsAmazingMorphologyClass::init() {
	create();
