...
EdgarsAmazingMorphologyClassVREP::EdgarsAmazingMorphologyClassVREP()
{
}
...
vector<int> EdgarsAmazingMorphologyClassVREP::getObjectHandles(int parentHandle)
{
	return vector<int>();
}

vector<int> EdgarsAmazingMorphologyClassVREP::getJointHandles(int parentHandle)
{
...
void EdgarsAmazingMorphologyClassVREP::update() {
	if (control) {
...
int EdgarsAmazingMorphologyClassVREP::getMainHandle()
{
	return mainHandle;
}
...
int EdgarsAmazingMorphologyClassVREP::morphologyInterpreter() { // credit to Wei
	//void parseCSV();
...
void EdgarsAmazingMorphologyClassVREP::init() {
	create();
 ...
 * \return - mainHandle 
 */
//int EdgarsAmazingMorphologyClassVREP::morphologyInterpreter()
//{
//	int mainHandle = 0;
//	// interpret body
//
